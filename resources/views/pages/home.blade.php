<x-layout title="Home">
        ...
        <div class="wrapper pt-20 pb-10 lg:py-[100px] relative z-10">
            <div class="wrapper-text hero-text">
                ...
                <button class="btn group">
                    ...
                    <span class="text-white text-base font-semibold">Explore Solutions</span>
                </button>
            </div>
        </div>
    </section>
                ...
                <div class="border border-taupe/40 rounded-sm p-5 flex-1">
                    <div class="w-full">
                        <div class="flex items-center justify-start gap-5">
                            <h4 class="text-3xl">67%</h4>
                            <p class="text-sm text-background/70">Staff Time Saved</p>
                        </div>
                    </div>
                </div>
                <div class="border border-taupe/40 rounded-sm p-5 flex-1">
                    <div class="w-full">
                        <div class="flex items-center justify-start gap-5">
                            <h4 class="text-3xl">95%</h4>
                            <p class="text-sm text-background/70">Query Resolution Rate</p>
                        </div>
                    </div>
                </div>
                <div class="border border-taupe/40 rounded-sm p-5 flex-1">
                    <div class="w-full">
                        <div class="flex items-center justify-start gap-5">
                            ...
                            <p class="text-sm text-background/70">Always Available Support</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="wrapper py-10">
            <div class="flex flex-col gap-2.5">
                <div class="wrapper-text">
                    ...
                    font-medium uppercase bg-primary-shade-80 border border-punch text-primary">our product</span>
    ...
    <section class="content-flex-center gap-[60px]">
        <div class="wrapper py-10 lg:py-[100px]">
            <div class="flex flex-col gap-2.5">
                <div class="wrapper-text">
                    <span
                        class="inline-flex items-center gap-x-1.5 py-1.5 px-3 rounded-full text-xs font-medium uppercase bg-primary-shade-80 border border-punch text-primary">Features</span>
                    <h2>Intelligence That Scales with Your Library</h2>
                    <p class="subheading-small">
                        Libriana.ai combines cutting-edge AI with professional library standards to deliver solutions
        ...
        <div class="flex flex-col gap-5">
            <div class="grid-card-3">
                <div class="border border-taupe/40 rounded-sm h-full flex flex-col relative">
                    ...
                    <div class="relative w-full h-64 shrink-0 overflow-hidden">
                        <img src="{{asset('img/bar-card.png')}}"
                    ...
                    <div class="space-y-5 p-5">
                        <h4>Smart Reference Analytics</h4>
                        <p>
                ...
                <div class="border border-taupe/40 rounded-sm h-full flex flex-col relative">
                    <!-- image -->
                    <div class="relative w-full h-64 shrink-0 overflow-hidden">
                        <img src="{{asset('img/card-flow.png')}}"
                    ...
                    <!-- Text-->
                    <div class="space-y-5 p-5">
                        <h4>Intelligent Service Automation</h4>
                        <p>
                ...
                <div class="border border-taupe/40 rounded-sm h-full flex flex-col relative">
                    <!-- image -->
                    <div class="relative w-full h-64 shrink-0 overflow-hidden">
                        <img src="{{asset('img/integration-card.png')}}"
                             class="w-full h-full object-cover absolute left-0 top-0"
                             alt="metrics"
                        >
                    </div>
                    ...
                    <!-- Text-->
                    <div class="space-y-5 p-5">
                        <h4>Predictive Library Intelligence</h4>
                        <p>
            ...
            <div class="grid-card-2">
                <div class="border border-taupe/40 rounded-sm h-full flex flex-col relative">
                    ...
                    <!-- Text-->
                    <div class="space-y-5 p-5">
                        <h4>Professional Development Tracking</h4>
                        <p>
                ...
                <div class="border border-taupe/40 rounded-sm h-full flex flex-col relative">
                    <!-- image -->
                    <div class="relative w-full h-64 shrink-0 overflow-hidden">
                        <img src="{{asset('img/searches-card.png')}}"
                    ...
                    <!-- Text-->
                    <div class="space-y-5 p-5">
                        <h4>Course Discovery Intelligence</h4>
                        <p>
    ...
    <section class="content-flex-center gap-[60px]">
        <div class="wrapper py-10 lg:py-[100px]">
            <div class="flex flex-col gap-2.5">
                <div class="flex flex-col items-center justify-center relative gap-6 mx-auto text-center">
                    <span
                        class="inline-flex items-center gap-x-1.5 py-1.5 px-3 rounded-full text-xs font-medium uppercase bg-primary-shade-80 border border-punch text-primary">why choose us</span>
                    <h2 class="max-w-[780px]">Why Leading Libraries Choose Our AI Solutions</h2>
                    <p class="subheading-small max-w-[600px]">
                        Empower your academic and public institutions with AI technology that transforms how libraries
                        serve their communities while maintaining the highest professional standards.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="grid-card-6">
            ...
            <div class="flex flex-col gap-5 border border-taupe/40 rounded-sm w-full h-full p-5">
                <div class="opacity-100 size-16">
                    <svg width="64" height="64" viewBox="0 0 64 64" fill="none" id="svg1488100570_1277">
                        ...
                        <path d="M27 31.9464L30.4018 35.3482L37 28.75" stroke="#FE4B01" stroke-width="2.90286"
            ...
            <div class="flex flex-col gap-5 border border-taupe/40 rounded-sm w-full h-full p-5">
                        ...
                        <g clip-path="url(#svg1978418783_3425_clip0_147_2328)">
                            ...
                            <g mask="url(#svg1978418783_3425_mask0_147_2328)">
                                <path
                                    ...
                                    fill="#FAA826" fill-opacity="0.25"></path>
                                <path
                ...
                <h4>Deep Service Analytics</h4>
                <p class="text-background/70">Unlock actionable insights through real-time dashboards tracking usage
                    patterns, user satisfaction, and service effectiveness.</p>
            </div>
            <!-- End box 2  -->
            <!-- box 3  -->
            <div class="flex flex-col gap-5 border border-taupe/40 rounded-sm w-full h-full p-5">
                <div class="opacity-100 size-16">
                    <svg width="64" height="64" viewBox="0 0 64 64" fill="none" id="svg-1539072092_1033">
                        ...
                        <rect x="0.5" y="0.5" width="63" height="63" rx="7.5" stroke="#FA6626"
                        ...
                        <path
                            ...
                            fill="#FAA826" fill-opacity="0.25"></path>
                        <path d="M27 32.1964L30.4018 35.5982L37 29" stroke="#FE4B01" stroke-width="2.90286"
                              stroke-linecap="round" stroke-linejoin="round"></path>
                        <defs>
                ...
                <p class="text-background/70">Automate routine tasks while freeing up staff for complex reference work
                    and meaningful patron engagement.</p>
            </div>
            <!-- End box 3  -->
            <!-- box 4  -->
            <div class="flex flex-col gap-5 border border-taupe/40 rounded-sm w-full h-full p-5">
            ...
            <div class="flex flex-col gap-5 border border-taupe/40 rounded-sm w-full h-full p-5">
                ...
                <h4>Expert Implementation Support</h4>
                <p class="text-background/70">Our 24/7 support team helps you integrate, customize, and optimize
                    Libriana.ai for your unique library environment.</p>
            </div>
            <!-- End box 6  -->
        </div>
    </section>
    ...
    <section class="content-flex-center">
        <div
            ...
            <div class="flex flex-col gap-5 pt-2.5 flex-1 justify-start">
                ...
                <h2 class="max-w-[480px]">Advanced Protection for Library Data</h2>
                ...
                <ul class="flex flex-col gap-4 text-background/70 text-sm">
                    <li class="flex items-start gap-3 pl-1">
                        ...
                        <span><strong class="text-background font-semibold">GDPR & Privacy Compliant:</strong> Built with data protection regulations at the core.</span>
                    </li>
                    <li class="flex items-start gap-3 pl-1">
                        <svg class="w-5 h-5 shrink-0 text-punch mt-0.5" fill="none" viewBox="0 0 24 24"
                             stroke="currentColor" stroke-width="2">
                        ...
                        <span><strong class="text-background font-semibold">Encrypted Communications:</strong> All interactions secured with end-to-end encryption.</span>
                    </li>
                    <li class="flex items-start gap-3 pl-1">
                        <svg class="w-5 h-5 shrink-0 text-punch mt-0.5" fill="none" viewBox="0 0 24 24"
                             stroke="currentColor" stroke-width="2">
                        ...
                        <span><strong class="text-background font-semibold">Audit Trails:</strong> Complete transparency with detailed logging and compliance reporting</span>
                    </li>
                    <li class="flex items-start gap-3 pl-1">
                        <svg class="w-5 h-5 shrink-0 text-punch mt-0.5" fill="none" viewBox="0 0 24 24"
                             stroke="currentColor" stroke-width="2">
                        ...
                        <span><strong class="text-background font-semibold">Role Based Access:</strong> Granular control over who accesses sensitive information</span>
                    </li>
                </ul>
    ...
    <section class="content-flex-center">
        <div class="flex flex-col md:flex-row items-center justify-center pb-20 relative w-full max-w-[1200px] mx-auto">
            ...
            <div class="flex flex-col gap-5 pt-2.5 flex-1 justify-start">
                <span
                    class="inline-flex w-fit items-center gap-x-1.5 py-[2px] px-3 rounded-full text-sm font-medium uppercase bg-primary-shade-80 border border-punch text-primary">Security</span>
                <h2 class="max-w-[480px]">
                    Data Security at Every Step
                </h2>
                <p class="text-background/70 max-w-[480px]">
                    Libriana.ai takes data security seriously with multi layered protection ensuring patron privacy,
                ...
                <ul class="flex flex-col gap-4 text-background/70 text-sm">
                    <li class="flex items-start gap-3 pl-1">
                        ...
                        <span><strong class="text-background font-semibold">256-bit encryption:</strong> excellent protection for all data.</span>
                    </li>
                    <li class="flex items-start gap-3 pl-1">
                        <svg class="w-5 h-5 shrink-0 text-punch mt-0.5" fill="none" viewBox="0 0 24 24"
                             stroke="currentColor" stroke-width="2">
                        ...
                        <span><strong class="text-background font-semibold">ISO 27001:</strong> International security standard compliance</span>
                    </li>
                    <li class="flex items-start gap-3 pl-1">
                        <svg class="w-5 h-5 shrink-0 text-punch mt-0.5" fill="none" viewBox="0 0 24 24"
                             stroke="currentColor" stroke-width="2">
                        ...
                        <span><strong class="text-background font-semibold">Regular penetration testing:</strong> Proactive vulnerability assessment.</span>
                    </li>
                    <li class="flex items-start gap-3 pl-1">
                        <svg class="w-5 h-5 shrink-0 text-punch mt-0.5" fill="none" viewBox="0 0 24 24"
                             stroke="currentColor" stroke-width="2">
                        ...
                        <span><strong class="text-background font-semibold">FERPA compliant:</strong> Educational records protection for academic libraries.</span>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <section
        ...
        <div class="flex flex-col items-center gap-5 max-w-[570px] mx-auto text-center">
            <span
                class="inline-flex items-center gap-x-1.5 py-1.5 px-3 rounded-full text-xs font-medium uppercase bg-primary-shade-80 border border-punch text-primary">Ready</span>
            <h2>Ready to Get Started?</h2>
            <p>Join the next generation of libraries powered by AI. Let's build future ready services that empower
                communities.</p>
            <button class="w-fit  btn group block">
                <div class="btn-icon group-hover:w-[calc(100%-0.5rem)]">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
