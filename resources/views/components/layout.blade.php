    ...
    <nav
        ...
        <div class="lg:col-span-3 flex items-center">
            ...
            <a class="flex-none rounded-xl text-xl inline-block relative h-9 w-[136px] font-semibold
               ...
               href="/" aria-label="Librana AI">
                <img src="{{ asset('/img/logo-text.svg') }}" class="w-full h-full object-contain" alt="Librana AI logo">
            </a>
            <!-- End Logo -->
        </div>
        ...
        <div class="flex items-center gap-x-1 lg:gap-x-2 ms-auto py-1 lg:ps-6 lg:order-3 lg:col-span-3">
            <a href="{{ route('contact-us') }}"
               class="btn group hidden lg:inline-flex bg-accent hover:bg-accent text-white transition-all">
                ...
                <span class="text-base font-semibold">Get Started</span>
            </a>
            ...
            <div
               ...
               md:gap-y-0 md:gap-x-7 md:mt-0">
                @foreach ([
                    ...
                    <div>
                        <a href="{{ route($route) }}"
                           class="relative inline-block px-1 py-0.5 text-white hover:text-accent transition-colors focus:outline-hidden">
                            {{ $label }}
                            @if(isActiveRoute($route))
                                <span class="absolute left-0 bottom-0 w-full h-[2px] bg-accent rounded-full"></span>
                            @endif
                        </a>
                    </div>
                @endforeach
        ...
        <div
            ...
            <div class="flex gap-5">
                ...
                <div class="flex gap-[6px] items-center">
                    ...
                    <a href="#"
                       class="flex justify-center items-center border border-transparent hover:border-accent/50 rounded-full size-[30px] transition-all">
                        <svg viewBox="0 0 21.333 19.283" overflow="visible"
                             class="size-4 fill-neutral/60 hover:fill-accent transition-all" id="svg1738607330_459">
                            <path
                    ...
                    <a href="#"
                       class="flex justify-center items-center border border-transparent hover:border-accent/50 rounded-full size-[30px] transition-all duration-300 ease-in-out">
                        <svg viewBox="0 0 20.627 23.51" overflow="visible" id="svg-1950279893_1776"
                             class="size-4 fill-neutral/60 hover:fill-accent transition-all">
                            <path
            ...
            <p class="text-sm text-neutral/60">
                ...
                <a href="https://github.com/macqueen006" target="_blank"
